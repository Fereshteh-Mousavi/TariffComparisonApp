...
namespace TariffComparisonTest
{
    public class TariffTests
    {
        ...
        [Theory]
        [InlineData(3500, "Packaged Tariff", 800.00)]
        ...
        public void CalculateAnnualCost_NegativeConsumption_ShouldThrowArgumentException()
        {
            ...
            // Act & Assert
            Assert.Throws<ArgumentException>(() => basicTariff.CalculateAnnualCost(-100));
            Assert.Throws<ArgumentException>(() => packagedTariff.CalculateAnnualCost(-100));
        }
    }
}
